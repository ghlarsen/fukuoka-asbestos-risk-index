...
For occupational air monitoring specifically, Hwang et al. (2021) demonstrated that NIOSH Method 7400 — a phase-contrast microscopy protocol used to assess airborne fibre exposure — systematically underestimates amphibole elongated mineral particle (EMP) concentrations (PMID 34768883). This finding is directly relevant to the question of whether workers conducting demolition in high-risk districts are accurately assessed for exposure, though it is analytically distinct from the bulk building material identification context of JIS A 1481.
...
4. Hwang J, et al. NIOSH Method 7400 underestimation of amphibole elongated mineral particles. *Journal of Occupational and Environmental Hygiene*. 2021. PMID: 34768883. [Phase-contrast microscopy (NIOSH 7400) systematically underestimates amphibole EMP exposures. Year corrected from "2014" to match PMID range ~2021; verify exact publication year before submission.]
